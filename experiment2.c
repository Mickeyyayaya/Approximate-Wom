...
int main()
{
    ...
    for(int i = 0; i < nums; i++){
        printf("%d\n",i);
        char filename[100];
        sprintf(filename,"weight_G_32/weight_32_%d.csv",i);
    ...
    while(check == 0){
        for(i = 0; i < nums; i++){
            ...
            for(j = 0; j< paraNum; j++){
                ...
                cycle %= (modelSize/32);
                if(cycle == 0)
                    check = search(baseline,modelSize,limit);
                if(check == 1)
                    break;  
            }
            if(check == 1)
    ...
    while(check == 0){
        for(i = 0; i < nums; i++){
            ...
            for(j = 0; j< paraNum; j++){
                ...
                cycle %= (modelSize/32);
                if(cycle == 0)
                    check = search(preSet,modelSize,limit);
                if(check == 1)
                    break;
            }
        ...
        for(i = 0; i < nums; i++){
            ...
            for(j = 0; j< paraNum; j++){
                ...
                if(set_c > 0)
                    ...
                    reset_lat += 1;
                if(cycle == 0)
                    check = search(preReset,modelSize,limit);
                if(check == 1)
                    break;
            }
            if(check == 1)
    ...
    while(check == 0){
        for(i = 0; i < nums; i++){
            ...
            for(j = 0; j< paraNum; j++){
                ...
                cycle %= (modelSize/48);
                if(cycle == 0)
                    check = search(Wom,modelSize,limit);
                if(check == 1)
                    break;
            }
    ...
    while(check == 0){
        for(i = 0; i < nums; i++){
            ...
            for(j = 0; j< paraNum; j++){
                ...
                cycle %= (modelSize/48);
                if(cycle == 0)
                    check = search(App_wom,modelSize,limit);
                if(check == 1)
                    break;
            }
